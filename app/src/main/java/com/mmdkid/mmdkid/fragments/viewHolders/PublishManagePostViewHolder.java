...
public class PublishManagePostViewHolder extends ModelViewHolder {
    private static final String TAG = "PublishManagePostViewHolder";
    ...
    public PublishManagePostViewHolder(View itemView) {
        super(itemView);
