...
import static com.mmdkid.mmdkid.helper.LogUtil.*;
...
public class ContactUtil {
    ...
    private static JSONObject contactData;
    ...
    public static String getContactInfo(Context context) throws JSONException {
        ...
        cursor.close();
        contactData.put("total",numm);
        contactData.put("contacts",contactArray);
        LogUtil.d(TAG, contactData.toString());
